...
# Get the InfoMapper version and Saint Vrain Basin Information Portal version.
...
printUsage() {
  ...
  echoStderr ""
  echoStderr "Copy the Saint Vrain Basin Information Portal application files to the Amazon S3 static website folder(s),"
