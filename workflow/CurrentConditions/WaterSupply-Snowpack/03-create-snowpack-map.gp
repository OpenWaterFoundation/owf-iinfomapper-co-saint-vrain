...
CreateGeoMap(NewGeoMapID="CurrentSnowpackMap",Name="Current Snowpack",Description="Current snowpack",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.4,40.17,11',docPath:snowpack-map.md")
...
#CopyFile(SourceFile="layers/co-dwr-water-district-5-event-config.json",DestinationFile="${MapFolder}/layers/co-dwr-water-district-5-event-config.json")
