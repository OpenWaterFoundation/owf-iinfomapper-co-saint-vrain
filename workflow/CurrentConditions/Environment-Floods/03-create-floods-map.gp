...
CreateGeoMap(NewGeoMapID="CurrentFloodsMap",Name="Flood Conditions",Description="Flood conditions",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.4,40.17,11',docPath:floods-map.md")
#CreateGeoMap(NewGeoMapID="CurrentFloodsMap",Name="Flood Conditions",Description="Flood conditions",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.4,40.17,11',docPath:floods-map.md")
...
# CopyFile(SourceFile="layers/co-dwr-water-district-5.md",DestinationFile="${MapFolder}/layers/co-dwr-water-district-5.md")
