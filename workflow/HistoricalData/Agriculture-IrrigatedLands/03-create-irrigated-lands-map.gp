# Create a GeoMapProject file for District 5 irrigated lands
...
CreateGeoMap(NewGeoMapID="IrrigatedLandsMap",Name="Irrigated Lands",Description="Irrigated lands from CDSS.",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.4,40.17,11',docPath:'irrigated-lands-map.md'")
...
#
#CopyFile(SourceFile="../../BasinEntities/Administration-CoDwrWaterDistricts/layers/co-dwr-water-district-5.md",DestinationFile="layers/co-dwr-water-district-5.md")
#CopyFile(SourceFile="../../BasinEntities/Administration-CoDwrWaterDistricts/layers/co-dwr-water-district-5-classify-district.csv",DestinationFile="layers/co-dwr-water-district-5-classify-district.csv")
...
AddGeoLayerViewToGeoMap(GeoLayerID="WaterDistrictLayer",GeoLayerViewID="WaterDistrictLayerView",Name="CO DWR Water District 5",Description="Water District 5 boundary from the Colorado Division of Water Resources",InsertPosition="Top",Properties="docPath:../../BasinEntities/Administration-CoDwrWaterDistricts/layers/co-dwr-water-district-5.md")
SetGeoLayerViewCategorizedSymbol(GeoLayerViewID="WaterDistrictLayerView",Name="Colorize district",Description="Show Water District 5 in black.",ClassificationAttribute="DISTRICT",Properties="classificationFile:../../BasinEntities/Administration-CoDwrWaterDistricts/layers/co-dwr-water-district-5-classify-district.csv")
SetGeoLayerViewEventHandler(GeoLayerViewID="WaterDistrictLayerView",EventType="hover",Name="Hover event",Description="Hover event configuration",Properties="eventConfigPath:../../BasinEntities/Administration-CoDwrWaterDistricts/layers/co-dwr-water-district-5-event-config.json")
...
#
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dwr/irrigated-lands/co-dwr-irrigated-lands-district5-1956.geojson",GeoLayerID="IrrigatedLands1956Layer",Name="District 5 Irrigated Lands",Description="Irrigated lands (1956) for District 5 from Colorado's Decision Support Systems.")
# The following layer view group is used for all years
AddGeoLayerViewToGeoMap(GeoLayerID="IrrigatedLands1956Layer",GeoLayerViewID="IrrigatedLands1956LayerView",Name="District 5 Irrigated Lands (1956)",Description="Irrigated lands (1956) from CDSS",InsertPosition="Top",Properties="docPath:layers/irrigated-lands.md,selectedInitial:false")
...
# GeoLayerViewGroupID: IrrigatedLandsGroup
#ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dwr/irrigated-lands/co-dwr-irrigated-lands-district5-1976.geojson",GeoLayerID="IrrigatedLands1976Layer",Name="District 5 Irrigated Lands",Description="Irrigated lands (1976) for District 5 from Colorado's Decision Support Systems.")
#AddGeoLayerViewToGeoMap(GeoLayerID="IrrigatedLands1976Layer",GeoLayerViewID="IrrigatedLands1976LayerView",Name="District 5 Irrigated Lands (1976)",Description="Irrigated lands (1976) from CDSS",InsertPosition="Top",Properties="docPath:layers/irrigated-lands.md,selectedInitial:false")
...
# GeoLayerViewGroupID: IrrigatedLandsGroup
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dwr/irrigated-lands/co-dwr-irrigated-lands-district5-1987.geojson",GeoLayerID="IrrigatedLands1987Layer",Name="District 5 Irrigated Lands",Description="Irrigated lands (1987) for District 5 from Colorado's Decision Support Systems.")
AddGeoLayerViewToGeoMap(GeoLayerID="IrrigatedLands1987Layer",GeoLayerViewID="IrrigatedLands1987LayerView",Name="District 5 Irrigated Lands (1987)",Description="Irrigated lands (1987) from CDSS",InsertPosition="Top",Properties="docPath:layers/irrigated-lands.md,selectedInitial:false")
...
# GeoLayerViewGroupID: IrrigatedLandsGroup
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dwr/irrigated-lands/co-dwr-irrigated-lands-district5-1997.geojson",GeoLayerID="IrrigatedLands1997Layer",Name="District 5 Irrigated Lands",Description="Irrigated lands (1997) for District 5 from Colorado's Decision Support Systems.")
AddGeoLayerViewToGeoMap(GeoLayerID="IrrigatedLands1997Layer",GeoLayerViewID="IrrigatedLands1997LayerView",Name="District 5 Irrigated Lands (1997)",Description="Irrigated lands (1997) from CDSS",InsertPosition="Top",Properties="docPath:layers/irrigated-lands.md,selectedInitial:false")
...
# GeoLayerViewGroupID: IrrigatedLandsGroup
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dwr/irrigated-lands/co-dwr-irrigated-lands-district5-2001.geojson",GeoLayerID="IrrigatedLands2001Layer",Name="District 5 Irrigated Lands",Description="Irrigated lands (2001) for District 5 from Colorado's Decision Support Systems.")
AddGeoLayerViewToGeoMap(GeoLayerID="IrrigatedLands2001Layer",GeoLayerViewID="IrrigatedLands2001LayerView",Name="District 5 Irrigated Lands (2001)",Description="Irrigated lands (2001) from CDSS",InsertPosition="Top",Properties="docPath:layers/irrigated-lands.md,selectedInitial:false")
...
# GeoLayerViewGroupID: IrrigatedLandsGroup
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dwr/irrigated-lands/co-dwr-irrigated-lands-district5-2005.geojson",GeoLayerID="IrrigatedLands2005Layer",Name="District 5 Irrigated Lands",Description="Irrigated lands (2005) for District 5 from Colorado's Decision Support Systems.")
AddGeoLayerViewToGeoMap(GeoLayerID="IrrigatedLands2005Layer",GeoLayerViewID="IrrigatedLands2005LayerView",Name="District 5 Irrigated Lands (2005)",Description="Irrigated lands (2005) from CDSS",InsertPosition="Top",Properties="docPath:layers/irrigated-lands.md,selectedInitial:false")
...
# GeoLayerViewGroupID: IrrigatedLandsGroup
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dwr/irrigated-lands/co-dwr-irrigated-lands-district5-2010.geojson",GeoLayerID="IrrigatedLands2010Layer",Name="District 5 Irrigated Lands",Description="Irrigated lands (2010) for District 5 from Colorado's Decision Support Systems.")
AddGeoLayerViewToGeoMap(GeoLayerID="IrrigatedLands2010Layer",GeoLayerViewID="IrrigatedLands2010LayerView",Name="District 5 Irrigated Lands (2010)",Description="Irrigated lands (2010) from CDSS",InsertPosition="Top",Properties="docPath:layers/irrigated-lands.md,selectedInitial:false")
...
# GeoLayerViewGroupID: IrrigatedLandsGroup
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dwr/irrigated-lands/co-dwr-irrigated-lands-district5-2015.geojson",GeoLayerID="IrrigatedLands2015Layer",Name="District 5 Irrigated Lands",Description="Irrigated lands (2015) for District 5 from Colorado's Decision Support Systems.")
AddGeoLayerViewToGeoMap(GeoLayerID="IrrigatedLands2015Layer",GeoLayerViewID="IrrigatedLands2015LayerView",Name="District 5 Irrigated Lands (2015)",Description="Irrigated lands (2015) from CDSS",InsertPosition="Top",Properties="docPath:layers/irrigated-lands.md,selectedInitial:false")
...
# GeoLayerViewGroupID: IrrigatedLandsGroup
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dwr/irrigated-lands/co-dwr-irrigated-lands-district5-2020.geojson",GeoLayerID="IrrigatedLands2020Layer",Name="District 5 Irrigated Lands",Description="Irrigated lands (2020) for District 5 from Colorado's Decision Support Systems.")
AddGeoLayerViewToGeoMap(GeoLayerID="IrrigatedLands2020Layer",GeoLayerViewID="IrrigatedLands2020LayerView",Name="District 5 Irrigated Lands (2020)",Description="Irrigated lands (2020) from CDSS",InsertPosition="Top",Properties="docPath:layers/irrigated-lands.md,selectedInitial:true")
...
#CopyFile(SourceFile="../../BasinEntities/Administration-CoDwrWaterDistricts/layers/co-dwr-water-district-5-event-config.json",DestinationFile="${MapFolder}/layers/co-dwr-water-district-5-event-config.json")
#CopyFile(SourceFile="../../BasinEntities/Administration-CoDwrWaterDistricts/layers/co-dwr-water-district-5.md",DestinationFile="${MapFolder}/layers/co-dwr-water-district-5.md")
#
