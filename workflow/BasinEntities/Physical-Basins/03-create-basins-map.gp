# Create a GeoMapProject file for basins for the Saint Vrain Basin:
...
# - GeoMapID:  BasinsMap
CreateGeoMapProject(NewGeoMapProjectID="BasinsProject",ProjectType="SingleMap",Name="Saint Vrain Basins",Description="Saint Vrain Basins",Properties="author:'Open Water Foundation',specificationFlavor:'',specificationVersion:'1.0.0'")
CreateGeoMap(NewGeoMapID="BasinsMap",Name="Saint Vrain Basins",Description="Saint Vrain Basins",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.3,40.1,10',docPath:basins-map.md")
