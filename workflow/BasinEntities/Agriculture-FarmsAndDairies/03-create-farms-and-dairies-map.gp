...
CreateGeoMap(NewGeoMapID="DairiesMap",Name="Farms and Dairies",Description="Farms and dairies",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.4,40.17,11',docPath:'farms-and-dairies-map.md'")
...
#CopyFile(SourceFile="../Administration-CoDwrWaterDistricts/layers/co-dwr-water-district-5-event-config.json",DestinationFile="layers/co-dwr-water-district-5-event-config.json")
