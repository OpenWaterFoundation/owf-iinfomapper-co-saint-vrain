# Create a GeoMapProject file for stream reaches for the Saint Vrain Basin:
...
CreateGeoMap(NewGeoMapID="StreamReachesMap",Name="Stream Reaches",Description="Stream Reaches",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.4,40.17,11',docPath:stream-reaches-map.md")
