...
CreateGeoMap(NewGeoMapID="WaterProvidersMap",Name="Water Providers",Description="Water Providers",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.4,40.17,11',docPath:'water-providers-map.md'")
...
#
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dola/district-boundaries/latest/co-fire-protection-districts-waterdistrict5.geojson",GeoLayerID="FireProtectionDistrictsLayer",Name="Fire Protection Districts",Description="Fire protection districts from DOLA.")
